...
router.get('/', auth, saucesControllers.getAllSauces); //On n'appelle pas la fonction, on l'applique à la route
...
router.post('/:id/like', auth, saucesControllers.likeDislikeSauce);
